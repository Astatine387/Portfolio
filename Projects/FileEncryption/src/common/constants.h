...
inline constexpr std::array<uint8_t, 4> kMagic = { 'F', 'E', 'N', 'C' };  /// Magic number of the chunked format
...
/* Constants of the superseded single-tag format, dropped as the engine stops referencing them */
...
inline constexpr uint32_t kMagicNum = 0xe07bca75;               /// Magic number
...
inline constexpr size_t kDataOffset = kKdfParamSize + kSaltSize + kIVSize;  /// Single-tag plaintext header size
