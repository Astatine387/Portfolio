...
/**
 * @enum    CryptoMode
 * @brief   Direction an EVP context is built for
 *
 * Local to this file. It labels nothing but the MakeCtx argument below, and PasswordManager itself
 * never picks a direction from a caller, so common/constants.h has no use for it.
 */
