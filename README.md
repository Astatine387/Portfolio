...
| Title                                                                                                                      | Difficulty                                            | Topics                                   | Time             | Space       | Runtime        | Memory             | Solution                                                                                                                                                                                           |
| -------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- | ---------------------------------------- | ---------------- | ----------- | -------------- | ------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| [121. Best Time to Buy and Sell Stock](./LeetCode/Easy/0121-best-time-to-buy-and-sell-stock)                               | ![Easy](https://img.shields.io/badge/Easy-43a047)     | Array, DP                                | O(n)             | O(1)        | 0 ms (100%)    | 97.28 MB (86.67%)  | [![Solution](https://img.shields.io/badge/Solution-%23FFA116?logo=leetcode&logoColor=white)](https://leetcode.com/problems/best-time-to-buy-and-sell-stock/submissions/1774620704/)                |
